...
const techno = () => {
  ...
  return (
    ...
    <div className='flex flex-wrap mdé:max-w-md gap-12 items-center justify-center'>
    <motion.div
          ref={ref}
          initial="hidden"
