    ...
    <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
      <li>
        <div className="flex items-center gap-x-6">
          ...
          <div>
            <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900">Monsif Souri</h3>
      ...
      <li>
        <div className="flex items-center gap-x-6">
          ...
          <div>
            <h3 className="text-base font-semibold leading-7 tracking-tight text-gray-900">Othman Sohab</h3>
